...
data class KateRequest private constructor(
    ...
    companion object {
        fun create(id: String=UUID.randomUUID().toString(), traceId: String, parentRequestId: String?=null, replyTopic: String? = null,
                   requestBody: KateRequestBody) =
                        KateRequest(id=id, traceId = traceId, parentRequestId = parentRequestId, replyTopic = replyTopic,
...
data class KateResponse private constructor(
    ...
    companion object {
        fun create(id: String=UUID.randomUUID().toString(), traceId: String, requestId: String, responseBody: KateResponseBody) =
            KateResponse(id=id, traceId = traceId, requestId = requestId,
...
data class KateEvent private constructor(
    ...
    companion object {
        fun create(id: String=UUID.randomUUID().toString(), traceId: String, eventBody: KateEventBody) =
            KateEvent(id=id, traceId = traceId, eventBodyType = eventBody.javaClass.canonicalName, eventBody = eventBody)
    }
}
