...
internal class CarRestController(private val service: CarService, val repo: WebRequestResponseRepository) {
    ...
    fun sellCarAdvice(type: CarType, licensePlate: String, yearBuilt: Int, minimumPriceEuros: Int): DeferredResult<CarAdviceResponse> {
        ...
        val deferredResult = repo.registerRequest(requestId, requestId, 500)
